...
// frontend/app/(dashboard)/academic/calendar/add/page.tsx
...
/**
 * AddAcademicEventForm component for adding new academic events.
 */
export default function AddAcademicEventForm() {
  const [formData, setFormData] = useState<AcademicEventFormData>({
    title: "",
    date: "",
    type: "",
    description: "",
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const newEvent = {
      ...formData,
      id: `EV${Math.random().toString(36).substring(2, 8).toUpperCase()}`, // Simple mock ID generation
    };
    console.log("New Academic Event Data:", newEvent);
    alert("Academic event added successfully! Check console for data.");
    // Optionally, clear the form or redirect to the calendar list page
    setFormData({
      title: "",
      date: "",
      type: "",
