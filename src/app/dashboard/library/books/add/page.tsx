...
// frontend/app/(dashboard)/library/books/add/page.tsx
...
/**
 * AddBookForm component for adding new books to the library.
 */
export default function AddBookForm() {
  ...
  const handleChange = (
    ...
    setFormData((prev) => ({
      ...prev,
      [id]: id === "totalCopies" ? parseInt(value) || 0 : value,
    }));
  };
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const newBook = {
      ...formData,
      id: `B${Math.random().toString(36).substring(2, 8).toUpperCase()}`, // Simple mock ID generation
    ...
    // Optionally, clear the form or redirect to the book list page
    setFormData({
      title: "",
      author: "",
      isbn: "",
